...
print_grid_(X,Y):-size(_,H),Y=<H,print_grid_cell(cell(X,Y),0),X0 is X+1,print_grid_(X0,Y).
% Prints the grid without lighting up normal tiles
print_grid:-print_grid_(1,1).

% print_grid_lit helpers
print_grid_lit_(X,Y):-size(W,_),X>W,X0 is 1,Y0 is Y+1,nl,nl,print_grid_lit_(X0,Y0).
print_grid_lit_(X,Y):-size(_,H),Y=<H,print_grid_cell(cell(X,Y),1),X0 is X+1,print_grid_lit_(X0,Y).
% Prints the grid with lighting up normal tiles
print_grid_lit:-print_grid_lit_(1,1).

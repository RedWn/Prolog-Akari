...
print_grid_(X,Y):-Y>0,print_grid_cell(cell(X,Y),0),X0 is X+1,print_grid_(X0,Y).
...
print_grid_lit_(X,Y):-Y>0,print_grid_cell(cell(X,Y),1),X0 is X+1,print_grid_lit_(X0,Y).
